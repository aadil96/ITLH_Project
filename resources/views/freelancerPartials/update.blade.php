                ...
                <div class="row justify-content-center">
                    <div class="col-lg-6">
                        ...
                        <form class="form-group" enctype="multipart/form-data
                                  action="/profile/ {{$user->id}}/edit" method="post">
                            @csrf

                            <input type="hidden" name="id" value="{{$user->id}}" autofocus>
                            ...
                            <input type="text" name="competencies" value="{{ $user->competencies }}" class="form-control">
