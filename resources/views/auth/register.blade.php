            ...
            <div class="card">
                ...
                <div class="card-body">
                    ...
                    <form action="{{ route('register')}}" enctype="multipart/form-data" method="post">
                        ...
                        <div class="form-group row">
                            <label for="profileImg" class="col-md-4 col-form-label text-md-right">{{ __('Profile Image') }}</label>

                            <div class="col-md-6">
                                <input id="profileImg" type="file" class="form-control @error('profileImg') is-invalid @enderror" name="profileImg" value="{{ old('profileImg') }}" autocomplete="profileImg">
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-6">
                                <input id="cv" type="file" class="form-control @error('cv') is-invalid @enderror" name="cv" value="{{ old('cv') }}" autocomplete="cv">
                        ...
                        <div class="form-group row">
                            <label for="cmpt" class="col-md-4 col-form-label text-md-right">{{ __('Competencies') }}</label>

                            <div class="col-md-6">
                                <input id="cmpt" type="text" class="form-control @error('cmpt') is-invalid @enderror" name="cmpt" value="{{ old('cmpt') }}" autocomplete="cmpt">
