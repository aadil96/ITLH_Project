...
@section('content')
    ...
    <div class="row ml-2 justify-content-center mb-5">
            ...
            <div class="card">
                ...
                <div class="card-body">
                    ...
                    <div class="container mt-3">
                        <img src="/storage/{{$assignment->specification_document_url}}" height="300" width="300"
                             alt="image not found">
                    </div>
                    ...
                    <div class="container mt-3 mb-5">
                        @guest('web')
                            <a href="{{route('proposal.post', ['assignment' => $assignment->id])}}"
                               class="btn btn-dark">
                                Apply for this job
                            </a>
                        @endguest
                                    ...
                                    <td>
                                        ...
                                        @auth('client')
                                            <a class="d-block text-right"
                                               href="{{ route('proposal', ['user' => $proposal->user->id, 'proposal' => $proposal->id]) }}">
                                                view more </a>
                                        @endauth
                                    </td>
                                </tr>
