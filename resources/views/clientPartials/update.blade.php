                ...
                <div class="row justify-content-center">
                    <div class="col-lg-6">
                        ...
                        <form class="form-group" action="/client/profile/{{$client->id}}/edit" method="post">
                            ...
                            <input type="hidden" name="id" value="{{$client->id}}" autofocus>

                            <label for="name">Enter new name</label>
                            <input type="text" name="company_name" class="form-control" placeholder="{{$client->company_name}}" required />

                            <label class="mt-3" for="email">Enter new email</label>
                            <input type="email" class="form-control" name="email" placeholder="{{$client->email}}" required>
